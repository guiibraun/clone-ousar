...
export const BemVindo = () => {
    return (
        <div className="bg-black min-h-screen bg-[url('/images/bg-section-one.png')] bg-cover bg-center flex">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-32 gap-y -8 items-center justify-between container py-8 px-2 md:py-16 lg:max-w-screen-lg xl:max-w-screen-xl">
